...
| Home Page                     | Details Page                        | Checkout                              | Confirmation                                  |
| ----------------------------- | ----------------------------------- | ------------------------------------- | --------------------------------------------- |
| ![Home](screenshots/home.png) | ![Details](screenshots/details.png) | ![Checkout](screenshots/checkout.png) | ![Confirmation](screenshots/confirmation.png) |
